...
export const providers: ProviderManifest[] = [
  {
    ...
    auth: 'Project-scoped sbp_fc token for the alpha · OAuth next',
    minimumAccess: 'Database Read · Proactive fixes every query to one configured table',
    ...
    safetyNote: 'The token must be scoped to this project with Database Read. Supabase’s read-only role can see broad project data, so Proactive fixes every request to this table.',
