...
export const preparedClips = [
  ...
  },
  {
    ...
    speakerId: 'cliff',
    speaker: 'Cliff · Checkout',
    text: "Retry guard is in. The three focused tests passed, and I've got a draft PR ready for review.",
    relevant: false,
    scene: 'code-patch',
  ...
  },
  {
    ...
    speakerId: 'kit',
    speaker: 'Kit · Incident commander',
    text: 'Email HR and Legal the rollout status, attach the approved policy, and flag that training has only reached 82 percent.',
    relevant: false,
    scene: 'mail-dispatch',
  ...
  },
  {
    ...
    speakerId: 'sienna',
    speaker: 'Sienna · Payments',
    text: 'HR and Legal have it, policy attached. While I have you, can we check whether Acme was promised SSO or SCIM by October, and draft the correction if we overcommitted?',
    relevant: false,
    scene: 'promise-check',
